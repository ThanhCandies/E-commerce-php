            ...
            <div class="content-body">
                ...
                <section id="data-thumb-view" class="data-thumb-view-header">
                        ...
                        <div class="btn-dropdown mr-1 mb-1">
                            <div class="btn-group dropdown actions-dropodown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="#" data-role="delete-list"><i
                    ...
                    <div class="add-new-data-sidebar">
                        ...
                        <form class="add-new-data" method="POST" action="{{route('products.create')}}" id="create_form"
                              novalidate>
                                ...
                                <div class="data-fields px-2 mt-3">
                                    <div class="row">
                                        <div class="col-sm-12 data-field-col form-group mb-0">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" id="data-name"
                                                   required="" name="name">
                                        ...
                                        <div class="col-sm-12 data-field-col form-group">
                                            ...
                                            <input autocomplete="off" type="text" class="form-control" id="data-price"
                                                   name="price" required="">
                                            <div class="help-block" style="right: inherit"></div>
                                        </div>
