...
@section('title',isset($exception)?$exception->getMessage():'404')
@section('content')
    ...
    <div class="col-xl-7 cl-md-8 col-12 d-flex justify-content-center ">
        <div class="card-content">
            <div class="card-body text-center">
                ...
                <h1 class="font-large-2 my-1">{{isset($exception)?$exception->getCode():'404'}} - {{isset($exception)?$exception->getMessage():'Page Not Found!'}}</h1>
                <p class="p-2">
