		...
		<header class="header">
			<div class="header__container">
				...
				<div class="header__auth">
					...
					<?php else : ?>
						<ul class="header__auth-list">
							<li class="nav__dropdown dropdown-user nav-item">
								<a class="nav-link dropdown-user-link" href="#" data-toggle="dropdown" aria-expanded="false" data-display="static">
											...
											<div class="media">
												...
												<div class="media-body">
													...
													<div class="d-flex justify-content-between align-items-center mt-1">
														<span class="align-middle d-block">1 x $299</span><i class="remove-cart-item feather icon-x danger font-medium-1"></i>
													</div>
												</div>
											</div>
										</a>
									</li>
									<li class="dropdown-menu-footer"><a class="dropdown-item p-1 text-center text-primary" href="/checkout"><i class="feather icon-shopping-cart align-middle"></i><span class="align-middle text-bold-600">Checkout</span></a></li>
